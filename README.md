...
These themes are recreations of the Windows 95C (OSR 2.5) GUI controls for GTK2, GTK3, GTK4, Xfce/Xfwm4 and Wine.

Windows 95C was when the Windows Desktop Update (Integrating Internet Explorer 4 into Windows Explorer) was bundled with the OS:
This introduced flat buttons and a few other things to the Explorer interface that eventually led to Windows 98 and Windows Me/2000's shells.
...
It does not focus on recreating a clone of a Windows 9x Desktop/Shell like its parent project, (Though this can be done!), rather, using its visual language
...
It was developed for Xfce4 v4.20: The ability to set a panel border is a fairly recent feature of Xfce so panels will not look right on much older versions
than this.
